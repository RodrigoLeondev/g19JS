...
btnEnviar.addEventListener('click',  () => {
    ...
    if( title !== '' && body !== '' && datepost !== '' ){ // Validación de que no hay datos vacíos
        ...
        // Ejecuta ajaxXHR, cuando este todo listo, manda a llamar
        // postCreated, luego la envías a esa url a la que se hará un POST 
        // y luego mandas el nuevo objeto creado newPost
